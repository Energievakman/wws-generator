...
def extract_wws_data(pdf_bytes):
    ...
    data = {
        ...
        "totaal_punten": clean_points(regex_find(text, r"Totaal aantal punten\s+(-?\s*[\d,.]+)")),
        "maximale_huurprijs": clean_money(regex_find(text, r"Maximale huurprijs\s+(€\s*[\d.,]+)")),
        "woning_punten": clean_points(regex_find(text, r"Woning\s+(-?\s*[\d,.]+)")),
        "binnenruimtes_punten": clean_points(regex_find(text, r"Binnenruimtes\s+(-?\s*[\d,.]+)")),
        "buitenruimtes_punten": clean_points(regex_find(text, r"Buitenruimtes\s+(-?\s*[\d,.]+)")),
        "bijzonderheden_punten": clean_points(regex_find(text, r"Bijzonderheden\s+(-?\s*[\d,.]+)")),
    }
